...
import Article1 from '../../public/images/articles/capm-article-image.png'
            ...
            <main className="w-full mb-16 flex flex-col items-center justify-center overflow-hidden dark:text-light">
                <Layout className="pt-16">
                    ...
                    <ul className="grid grid-cols-2 gap-16">
                        ...
                        img={Article1}
                        summary='The Capital Asset Pricing Model (CAPM) describes the relationship 
                        between systematic risk, or the general perils of investing, and 
                        expected return for assets, particularly stocks.'
                        time='20 min read'
                        link='https://www.investopedia.com/terms/c/capm.asp'
                        />
                        <FeaturedArticle
